    ...
    <main class='paymentstatus'>
        <?php
            if ($courseRegistrationPaymentQueryResult) {
                ...
                echo "<p><a href='learning_course_detail.php?courseregistrationId=" . $getCourseRegistrationPaymentRow['courseRegistrationId'] . "'>View my course</a></p>";
            } else {
