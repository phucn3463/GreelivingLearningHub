            ...
            <?php
                if (mysqli_num_rows($applicationResult) == 0) {
                    ...
                    while ($applicationDetails = mysqli_fetch_assoc($applicationResult)) {
                        ...
                        echo "<br/>";
                        echo "<p>Application CV: <a href='" . $applicationDetails['cv'] . "'>View CV</a></p>";
                        echo "<p>Application status: " . $applicationDetails['status'] . " <a href='change_status.php?applicationId={$applicationDetails['jobApplicationId']}'>Change status</a> </p>";
                        ...
                        if ($applicationDetails['status'] == 'Awaiting Interview') {
                            ...
                            if (!$appointmentQueryResult) {
                                ...
                                if ($appointmentRow) {
                                    ...
                                    echo "<p>Appointment: " . $appointmentRow['appointmentStart'] . " - " . $appointmentRow['appointmentEnd'] . " <a href='change_appointment.php?jobApplicationId={$appointmentRow['jobApplicationId']}'>Change appointment</a> </p>";
                                } else {
