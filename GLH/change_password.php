...
<body>
    ...
    <div class="change-password-section">
        ...
        ?>
        <form action="" method="post" class="form-change-password">
            <div class="form-change-password-section">
                <div class="form-change-password-element">
                ...
                <input type="submit" value="Update Password" name="update_pass" class="form-change-password-button"/>
            </div>    
        </form>
    </div>
