...
<body>
    ...
    <main>
        ...
        <form action="register_course_process.php" method="post" id="paymentform">
        
        <div>
            <label id="onlinePaymentMethodLabel">Choose your payment option:</label>
        ...
        <div>
            <button type="submit" name="registerCourse">Register</button>
        </div>
    </form>
