...
<body>
    ...
    <div class="create-job-section">
        <h3 class="create-job-title">Create a Job</h3>
        <form action="create_job_process.php" method="post" class="form-create-job">
            <div class="form-create-job-section">
                <div class="form-create-job-element">
                    <span>Title:</span>
                ...
                <input type="submit" value="Create new job" name="create_job" class="form-create-job-button"/>
            </div>    
        </form>
    </div>
    <?php
