                ...
                <?php 
                    ...
                    if (mysqli_num_rows($course_result) > 0) {
                        while ($course_row = mysqli_fetch_assoc($course_result)) {
                            ...
                            echo "<p><a href='learning_course_detail.php?courseregistrationId=" . $course_row['id'] . "'>View detail </a></p>";
                            echo '</div>';
                        }
                    } else {
                        echo "<div class='nocontent'><p>There is no course to display.</p></div>";
                    }
                ?>
            </div>
            ...
            <div class='contents'>
                <?php 
                    ...
                    if (mysqli_num_rows($job_application_result) > 0) {
                        ...
                        echo "<div class='nocontent'><p>There is no job application to display.</p></div>";
                    }
                ?>
            </div>
            ...
            <div class='contents'>
                <?php 
                    ...
                    if (mysqli_num_rows($candidate_experience_result) > 0) {
                        ...
                        echo "<div class='contentcv'>";

                        echo "<p>My experiences:</p>";
                        echo "<ul>"; 
                        ...
                        echo "<div class='nocontent'><p>There is no experience to display.</p>";
                    }

                    echo "<p class='editcv'><a href='online_cv.php?candidateId=" . $canId . "'>Edit my online CV</a></p>";
