...
<body>
    ...
    ?>
    <main>
        <div class="change-appointment-section">
            <h1>Set Appointment</h1>

            <form action='change_appointment.php' method='GET' class="form-change-appointment">
                <input type="hidden" name="jobApplicationId" value="<?php echo $jobApplicationId; ?>">
                <div class="form-change-appointment-section">
                    <div class="form-change-appointment-element">
                    ...
                    <input type='submit' name='update_appointment' value='Update appointment interview' class="form-change-status-button">
                </div>
            </form>
        </div>
