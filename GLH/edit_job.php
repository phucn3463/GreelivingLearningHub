...
<body>
    ...
    <main>
        <h1 class="edit-job-title">Update job's information</h1>
        <div class="edit-job-section">
            <form method="post" action="edit_job.php?jobId=<?php echo $jobId; ?>" class="form-update-job">
                <div class="form-edit-job-section">
                    <div class="form-edit-job-element">
                        <span>Title:</span>
                    ...
                    <input type="submit" value="Update job" name="update_job" class="form-edit-job-button"/>
                </div>    
            </form>
        </div>
    </main>
