...
<body>
    ...
    <div class="create-profile">
        ...
        <form action="" method="post" class="form-create-profile">
            <div class="form-create-profile-section">
                <div class="form-create-profile-element">
                ...
                ?>
                <input type="submit" value="Create Profile" name="create_profile" class="form-create-profile-button"/>
            </div>    
        </form>
    </div>
    <?php
