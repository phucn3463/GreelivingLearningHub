...
<body>
    ...
    <main>
        <div class="job-detail-employer">
            <h1>Job's detail</h1>
            <div class="job-detail-employer-section">
                <div class="job-detail-employer-detail">
                    <h2 class="job-detail-title">Title: <?php echo $jobQueryRow['jobTitle']; ?></h2>
                    <p>Specialization: <?php echo $jobQueryRow['jobSpec']; ?></p>
                    <div class="job-detail-employer-element">
                    ...
                    <div class="job-detail-employer-elements">
                        <a href="view_applications.php?jobId=<?php echo $jobQueryRow['jobId']; ?>" class="job-detail-employer-3elements">View Applications</a>
                        <a href="edit_job.php?jobId=<?php echo $jobQueryRow['jobId']; ?>" class="job-detail-employer-3elements">Edit Details</a>
                        <a href="delete_job.php?jobId=<?php echo $jobQueryRow['jobId']; ?>" class="job-detail-employer-3elements">Delete Job</a>
                    </div>
                </div>
            </div>
        </div>
